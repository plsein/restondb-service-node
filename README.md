# RestOnDB-Service-Node

This is a NodeJS plug & play service that provides dynamic / automatic REST and GraphQL APIs on any relational database by using the RestOnDB-RESTQL-Node as underlying service.
It uses Express with Apollo client for GraphQL and Axios for REST APIs along with JWT.
...
```bash
aws cloudformation delete-stack --stack-name service-apis
```
